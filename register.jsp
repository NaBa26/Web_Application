...
<head>
<meta charset="UTF-8">
<title>Travelex.com | Book Flights, Cabs, Rentals, Trains and Buses</title>
					...
					<div class="sign-in-htm">
						<div class="group">
							<label for="user" class="label">Email</label> <input id="user"
								type="text" class="input" name="lemail">
						</div>
						<div class="group">
							<label for="pass" class="label">Password</label> <input id="pass"
								type="password" class="input" data-type="password" name="lpassword">
						</div>
						<div class="group">
					...
					<div class="sign-up-htm">
						...
						<div class="group">
							<label for="pass" class="label">Repeat Password</label> <input
								id="pass" type="password" class="input" data-type="password" name="rpassword">
						</div>
						<div class="group">
